...
session_start();
$consulta ="SELECT docenteID FROM tbl_docentes where usuarioid=".$_GET['usuarioID'];
$resultado = $conexion->ejecutarconsulta($consulta);
$docenteid=$resultado->fetch_array()['docenteID'];

$consulta = "DELETE FROM tbl_docentesxcurso  WHERE docenteID =".$docenteid;
$conexion->ejecutarconsulta($consulta);

$consulta = "DELETE FROM tbl_docentes  WHERE docenteID =".$docenteid;
$conexion->ejecutarconsulta($consulta);
...
echo '<script>alert("Docente eliminado");</script>';
