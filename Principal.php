...
<body style="background: #f8f8ff;">
  ...
  <div class="container">
    ...
    <div class="row align-items-center my-5">
      ...
      <!-- /.col-lg-8 -->
      <div class="col-lg-5">
        <?php $consulta="SELECT nombreInstitucion FROM tbl_instituciones where institucionID=".$_SESSION['Institucion'];
          $resultado=$conexion->ejecutarconsulta($consulta);
         
        echo '<h1 class="font-weight-light">'.$resultado->fetch_assoc()['nombreInstitucion'].' </h1>';
        ?>
